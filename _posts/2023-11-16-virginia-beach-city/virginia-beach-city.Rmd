...
::: {style="display: flex;"}
::: {style="flex-direction: column; margin-right: 20px;"}
![Figure 10: *Minority Population Percentage by Precinct*](fig5demvote.svg){width="328"}
:::

::: {style="flex-direction: column;"}
![Figure 11: *Percent of Democratic Votes Compared to Minority Population Percentages in Majority Minority Precincts*](fig6demperf.svg){width="328"}
...
Three [constraints](https://alarm-redist.org/redist/reference/constraints.html) are added to simulations to promote a majority black district in simulated plans:
...
![Figure 7: *Elementary School Zoning Boundaries Overlaid on City Council Districts. Elementary school boundaries are in blue, while City Council districs are in red.*](fig7eszoningr.svg)
