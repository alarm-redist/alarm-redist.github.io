...
::: {style="display: flex;"}
::: {style="flex-basis: 50%; flex-direction: column;"}
![Figure 9: *Percent of Democratic Votes by Precinct.* Color and percent indicate a precinct's partisan tilt.](FINALdem.svg)
:::

::: {style="flex-basis: 50%; flex-direction: column;"}
![Figure 10: *Percent of Democratic Votes Compared to Minority Percentages in Majority-Minority Precincts*](FINALdemmmp.svg)
:::
:::
...
![Figure 11: *Simulated Majority Minority District Counts*](FINALminperfplot.png)
...
![Figure 12: *Percent of All Simulations Where the Precinct is in a Simualted MMD.*](FINALpercentmmd.svg){width="45%"}

</center>

### Do the New Maps Have Partisan Gerrymandering?

Although it is likely that two Democratic districts are being packed, Virginia Beach voters often vote split-ticket on the local level, having elected two Democratic councilmembers in safe Republican seats.

![Figure 13: *Democratic vote share by district in simulated runs. Black squares indicate the actual democratic vote share in the enacted plan, ordered by lowest to highest.*](FINALexpecteddem.png)

![Figure 13: *Democratic vote share by district in simulated runs. Black squares indicate the actual democratic vote share in the enacted plan, ordered by lowest to highest.*](demrepsplit.png)

### Are the New Maps Competitive?

![Figure 14: *Democratic vote share by district in simulated runs. Black squares indicate the actual democratic vote share in the enacted plan, ordered by lowest to highest.*](FINALcompetitiveness.png)
...
::: {style="display: flex;"}
::: {style="flex-basis: 50%; flex-direction: column;"}
![Figure 15: *Map of Voting Precincts and City Council Boundaries in Virginia Beach City*](FINALespre.svg)
:::

::: {style="flex-basis: 50%; flex-direction: column;"}
![Figure 16: *Map of Voting Precincts and Elementary School Boundaries in Virginia Beach City*](FINALes.svg)
:::
:::
