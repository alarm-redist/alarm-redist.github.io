...
![Figure 11: *Simulated Majority Minority District Counts*](fig7minperfplot.png)
...
![Figure 12: *Percent of All Simulations Where the Precinct is in a Simualted MMD.* ](FINALpercentmmd.svg){width="60%"}
...
![Figure 14: *Democratic vote share by district in simulated runs. Black squares indicate the actual democratic vote share in the enacted plan, ordered by lowest to highest.*](competitiveness.png)
