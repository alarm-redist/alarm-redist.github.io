...
![Figure 7: *Elementary School Zoning Boundaries Overlaid on City Council Districts. Elementary school boundaries are in blue, while City Council districs are in red.*](fig7eszoningr.svg){width="50%"}
...
| Count of plans                                | 1 district | 2 districts | 3 districts | 4 districts | 5 districts |
|-----------------|---------|---------|---------|---------|---------|
| Exactly *n* districts                         | 95824      | 88121       | 13811       | 2176        | 68          |
| At least *n* districts                        | 200000     | 104176      | 16055       | 2244        | 68          |
| \% of simulations with at least *n* districts |            | 52.09%      | 8.03%       | 1.12%       | 0.034%      |

: Table 3: Majority-Minority District appearance rate in 200,000 simulations

| Count of plans                                | 0 districts | 1 districts |
|-----------------------------------------------|-------------|-------------|
| Exactly *n* districts                         | 143829      | 56171       |
| \% of simulations with at least *n* districts | 100%        | 28.09%      |
...
![Figure 8: *Democratic vote share by district in simulated runs. Black squares indicate the actual democratic vote share in the enacted plan, ordered by lowest to highest.*](mmdoccurance.svg){width="70%"}

</center>

### Do the New Maps Have Partisan Gerrymandering?

![Figure 9: *Democratic vote share by district in simulated runs. Black squares indicate the actual democratic vote share in the enacted plan, ordered by lowest to highest.*](demrepsplit.png)

### Are the New Maps Competitive?
![Figure 10: *Democratic vote share by district in simulated runs. Black squares indicate the actual democratic vote share in the enacted plan, ordered by lowest to highest.*](competitiveness.png)
