...
The ten districts and 108 precincts are displayed in Figure 1 below, as well as the blocks in Figure 2.

::: {style="display: flex;"}
::: {style="flex-direction: column; margin-right: 20px;"}
![Figure 1](fig1ccandprecincts.png){width="328"}

::: {style="width: 328px;"}
*Map of Voting Precincts and City Council Boundaries in Virginia Beach City*
:::
:::

::: {style="flex-direction: column;"}
![Figure 2](fig2ccandblocks.png){width="328"}

::: {style="width: 328px;"}
*Map of Blocks and City Council Boundaries in Virginia Beach City*
:::
:::
:::
...
::: {style="flex-direction: column;"}
![Figure 6](fig6demperf.svg){width="328"}

::: {style="width: 328px;"}
*Percent of Democratic Votes Compared to Minority Population Percentages in Majority Minority Precincts*
:::
:::
:::
...
![](images/validation_20230903_2333.png)
...
#### Minority Gerrymandering: Virginia Beach City is Compliant with the Voting Rights Act
