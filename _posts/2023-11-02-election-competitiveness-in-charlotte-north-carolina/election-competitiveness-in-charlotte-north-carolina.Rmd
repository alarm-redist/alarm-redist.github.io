---
title: "Competitiveness in Charlotte, North Carolina"
description: |
...
![](citycouncilpartisanshipenacted.png)

*Figure 4: The above map shows the current city council partisan breakdown, which includes five Democratic and two Republican district; blue is Democrat, red is Republican.*

![](meanpartisanvotessimulations.png)

*Figure 5: The above map shows the expected partisan breakdown over the simulated plans, calculated by taking the mean of the democratic vote share across every simulation; blue is Democrat, red is Republican, with darker colors indicating more extreme percentages.*

By comparing these two maps to one another, it becomes clear that six of these districts should be Democratic according to the simulations, but there are only five Democratic districts in the currently enacted plan. One of the districts that is currently Republican should be Democratic according to the simulations we ran.

We also want to confirm that not only is the average percentage of Democratic voters in that district greater than 50%, but also that it is over 50% in a large percentage of the simulations. We do this by creating a box plot of the democratic vote share for the enacted plan versus the simulations.
...
From this box plot, we can recognize that the second ordered district is the one we are concerned about, as it is right on the edge between Democratic and Republican. More importantly, the plot shows us that in at least 75% of the simulations, the district is Democratic. It also highlights that, in the enacted plan, the democratic vote share is still very close to 50%. This strengthens our previous point, by emphasizing that this district is Democratic in a large percentage of cases, so the enacted map is very clearly an anomaly.

These maps and box plots come together to explain the difference between the partisan shift in the mayor election and in the city council election in Charlotte.
