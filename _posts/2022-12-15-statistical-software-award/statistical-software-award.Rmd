...
Last week, Chris Kenny, Cory McCartan, Ben Fifield, and Kosuke Imai received this year's [Statistical Software Award from the Society for Political Methodology](https://polmeth.org/statistical-software-award) for the R package `redist`.
...
`redist` is a key tool for much of our work, which has enabled work on [identifying bias in Census 2020](https://www.science.org/doi/10.1126/sciadv.abk3283), [creating alternative plans for all 50 states](https://www.nature.com/articles/s41597-022-01808-2), [reducing malapportionment in Japan](https://alarm-redist.org/posts/2022-09-30-nikkei/), [assessing partisan bias in 2022's congressional districts](https://alarm-redist.org/posts/2022-08-14-gerrymandering-mostly-cancels-nationally/), and more.
