...
```{r}
knitr::include_graphics('state_sum.pdf')
```
...
```{r}
knitr::include_graphics('manipulation.pdf')
```

If you're interested in more information on our findings or methods, take a look here **insert link to paper**.
