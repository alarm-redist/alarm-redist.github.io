...
<p style="text-align:right;">**日本語** / [**English**](japan-47-pref-english.html)</p>
...
```{r include=F}
prefs = Sys.glob(here("_japan-47-pref/analyses/*_*")) |>
    basename() |>
    substr(1, 2) |>
    as.integer()
```
...
d_appor = read_csv(here("_japan-47-pref/pref_code.csv"))

japan = readRDS(here("_japan-47-pref/carto_japan.rds")) %>%
    st_set_crs(NA) %>%
