...
usa$link[usa$STUSPS == 'CO'] <- 'https://www.christophertkenny.com/alarm-redist.github.io/fifty-states/DS_cd_2020.html'
...
p <- usa %>%
    ...
    theme_void() +
    guides(fill = 'none') + 
    wacolors::scale_fill_wa_d(which = c('paintbrush', 'ground'), palette = 'rainier')

```

This page largely links to subpages, with one for each state 
...
All data will be hosted on the ALARM Project [Harvard Dataverse](https://dataverse.harvard.edu/dataset.xhtml?persistentId=doi:10.7910/DVN/SLCD3E&version=DRAFT).
